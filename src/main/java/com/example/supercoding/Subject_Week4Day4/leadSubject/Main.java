...
// 1. 고객 생성합니다.
                ...
                Customer customer4 = new Customer("Bob", 21, Gender.MALE);
...
// 2. 주문 아이템을 만듭니다.
                ...
                orders.add(new Order(1004, customer2, LocalDate.of(2023,11,9), OrderStatus.ON_ODRED, null));
                ...
                validStatus.add(OrderStatus.DELIVERD);
        ...
        System.out.println(OrderStatus.DELIVERD);
    }
}
