...
public class ScoreTest {
    public static void main(String[] args) {
        ...
        String lowestMan =  students.stream().filter((student) -> student.getGender().equals("남자"))
        ...
        double femaleTopAverageScore = students.stream().filter((student) -> student.getGender().equals("여자"))
